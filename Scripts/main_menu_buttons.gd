...
func _on_play_button_pressed() -> void:
	...
	_play_scene_transition("res://Scenes/Game/GameNormal.tscn")
...
func _on_hard_core_button_pressed() -> void:
	...
	_play_scene_transition("res://Scenes/Game/GameHardcore.tscn")

func _on_infinite_mode_pressed() -> void:
	PlayerScore.game_mode = GameMode.GameModeEnum.INFINITY
	_play_scene_transition("res://Scenes/Game/GameInfinite.tscn")
